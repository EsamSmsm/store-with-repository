...
import 'package:hospital25/core/languages/app_localization.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ThemeCubit, ThemeState>(
      builder: (context, state) {
        final isArabic = _locale != null && _locale!.languageCode == 'ar';
        return MaterialApp(
          ...
          builder: (context, navigator) {
            ...
            return Theme(
              data: (isDark
                  ? AppTheme.getLightTheme(isArabic: isArabic)
                  : AppTheme.getLightTheme(isArabic: isArabic))
                ..copyWith(
                  textTheme: Theme.of(context).textTheme.apply(
                        fontSizeDelta: 1,
                        fontSizeFactor: isArabic ? 1.1 : 1.1,
                      ),
                ),
              child: navigator ??
                  Container(
